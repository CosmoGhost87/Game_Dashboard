...
fig.update_layout(xaxis_title_text = 'Developer', yaxis_title_text = 'Score', template = "plotly_dark", width = 1470, autosize = False, title = "Средняя оценка игр по компаниям-разработчикам", paper_bgcolor='rgba(0,0,0,0)')
fig2 = go.Figure()
fig2.add_trace(go.Histogram(x=dfred["developer"], y=dfred["index"], name='Amount', marker_color = '#a60c0c'))
fig2.update_layout(xaxis_title_text = 'Developer', yaxis_title_text = 'Amount', template = "plotly_dark", width = 1470, autosize = False, title = "Количество выпущенных игр по компаниям-разработчикам", paper_bgcolor='rgba(0,0,0,0)')
