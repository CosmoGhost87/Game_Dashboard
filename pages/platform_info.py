...
dfheat1 = dfheat.sort_values(by="index",ascending=False).head(400).sort_index()
...
dfheat2 = dfheat.sort_values(by="index",ascending=False).tail(len(dfheat)-400).sort_index()
