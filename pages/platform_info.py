...
fig.update_layout(font_family="Play", template = "plotly_dark", paper_bgcolor='rgba(0,0,0,0)',autosize = False, width = 1470, height = 1000, title = "Количество выпущенных игр по платформам")
fig2 = go.Figure()
fig2.add_trace(go.Heatmap(x=dfheat1["genre"], y=dfheat1["platform"], z=dfheat1["index"]))
fig2.update_layout(font_family="Play", template = "plotly_dark", paper_bgcolor='rgba(0,0,0,0)', width = 1470, height = 1000, autosize = False, title = "Количество выпущенных игр по жанрам и платформам (первая треть)")
fig3 = go.Figure()
fig3.add_trace(go.Heatmap(x=dfheat2["genre"], y=dfheat2["platform"], z=dfheat2["index"]))
fig3.update_layout(font_family="Play", template = "plotly_dark", paper_bgcolor='rgba(0,0,0,0)', width = 1470, height = 1000, autosize = False, title = "Количество выпущенных игр по жанрам и платформам (вторая треть)")
fig4 = go.Figure()
fig4.add_trace(go.Heatmap(x=dfheat3["genre"], y=dfheat3["platform"], z=dfheat3["index"]))
fig4.update_layout(font_family="Play", template = "plotly_dark", paper_bgcolor='rgba(0,0,0,0)', width = 1470, height = 1000, autosize = False, title = "Количество выпущенных игр по жанрам и платформам (третья треть)")
