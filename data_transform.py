...
df["publisher"] = df["publisher"].str.replace("Not specified", "Not specified")
df["developer"] = df["developer"].fillna("Not specified")
df["developer"] = df["developer"].str.replace("Not specified", "Not specified")
df["uscore"] = df["uscore"].str.replace("tbd", "0")
